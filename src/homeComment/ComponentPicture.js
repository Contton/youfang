        ...
        return(
            <div id="container">
                ...
                <div className="picture_find radius">
                    <input ref="searchInput" className="picture_input radius font_14" type="text" placeholder="搜索城市，大学，游记，攻略等"/>
                    <input onClick={()=>{
                        let value = this.refs.searchInput.value;
                        this.props.push("/search/" + value)
                    }} value="搜索" className="picture_button radius font_14 color_white background" type="button"/>
                </div>
